    ...
    <div class="position-relative">
        <div class="position-absolute w-100 fade-in" style="z-index: 10; top: 10rem"">
            <div class="container w-50 mx-auto">
                ...
                <p><b>From the bikol word, <i>“linigon”</i> is a website that offers home cleaning services provided by local service workers. It aims to shorten the gap between customers and service workers.</b> Through this website, you can forget the hassle of finding reliable people to solve your cleaning problems!</p>
            </div>
        </div>
        <div class="position-relative">
            <svg width="100%" height="100%" viewBox="0 0 1920 695" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_319_1958)">
                <rect width="1920" height="403" fill="#3FD4F8"/>
                <rect x="1958.13" y="694.619" width="1980.16" height="403" transform="rotate(-171.881 1958.13 694.619)" fill="#3FD4F8"/>
                </g>
                <defs>
                <clipPath id="clip0_319_1958">
                <rect width="1922" height="695" fill="white" transform="translate(-2)"/>
                </clipPath>
                </defs>
                </svg>                
        </div>
    ...
    <div class="container w-50">
        <div class="row">
            <div class="col">
                ...
                <h1 class="fw-bolder">FREQUENTLY ASKED <br> QUESTIONS.</h1>
            </div>
            <div class="col">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            What mode of payments are available for Linig-On?
                        </button>
                      </h2>
