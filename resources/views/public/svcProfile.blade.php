	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<div class="col-md-12 col-sm-8 shadow p-4 mb-5 rounded-5 border border-1" style="float: none; width: 100%;">{!! $workerInfo->service_info !!}</div>
				<div class="col-md-12 col-sm-8" style="float: none; width: 100%;">
